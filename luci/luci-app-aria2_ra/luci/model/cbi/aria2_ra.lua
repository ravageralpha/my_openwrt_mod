...
if running then
	m = Map("aria2_ra", translate("aria2"), translate("aria2 is running") .. yaaw .. aria2_webui)
else
	m = Map("aria2_ra", translate("aria2"), translate("aria2 is not running,make sure you have mounted USB Storage device"))
end

s = m:section(TypedSection, "aria2_ra", translate("Settings"))
s.anonymous = true
...
-- Network
network=m:section(TypedSection, "aria2_ra", translate("Network"))
...
-- Authentication
rpc=m:section(TypedSection, "aria2_ra", translate("Authentication"))
rpc.anonymous = true
